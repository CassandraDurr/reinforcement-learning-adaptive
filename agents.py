...
class QLearningAgent:
    ...
    def choose_action(self, state: int):
        """Selects an action based on the exploration strategy and updates epsilon."""
    ...
    def update_epsilon(self):
        """Updates epsilon based on the decay type."""
    ...
    def display_q_table(
        self, grid_size: tuple[int, int], actions: list[str] = ["↑", "↓", "←", "→"]
    ):
        """Displays the Q-table in a grid format for easier visualization.
    ...
    def display_state_q_values(
        ...
        """Displays the Q-values and the best action for a single state.
...
class DynaQPlusAgent(QLearningAgent):
    def __init__(
        ...
        """A tabular Dyna-Q+ agent with novelty bonus for exploration."""
        super().__init__(
            state_size=state_size,
            action_size=action_size,
            learning_rate=learning_rate,
